...
/**
 * Convert a string into a {@link org.arjenm.phpsecurity.analyzer.Risk} for {@link com.beust.jcommander.JCommander}.
 *
 * @author Arjen
 */
public class CliRiskConverter implements IStringConverter<Risk>
{
	@Override
	public Risk convert(String s)
	{
		return Risk.valueOf(s.trim());
	}
}
