...
public class PTAClassStaticStatement extends ClassStaticStatement
{
	/**
	 * Creates the echo statement.
	 */
	public PTAClassStaticStatement(Location location, String className, VarExpr var, Expr initValue)
	{
