...
public class PTAStaticStatement extends StaticStatement
{
	/**
	 * Creates the echo statement.
	 */
	public PTAStaticStatement(Location location, VarExpr var, Expr initValue)
	{
		super(location, var, initValue);
	}
