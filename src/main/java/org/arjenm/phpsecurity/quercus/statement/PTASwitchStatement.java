...
/**
 * SwitchStatement with access to the labels and blocks.
 *
 * @author Arjen
 */
public class PTASwitchStatement extends SwitchStatement
{
	public PTASwitchStatement(Location location, Expr value, ArrayList<Expr[]> caseList, ArrayList<BlockStatement> blockList, Statement defaultBlock, String label)
	{
