...
public class PTAFunctionDefStatement extends FunctionDefStatement
{
	public PTAFunctionDefStatement(Location location, Function fun)
	{
		super(location, fun);
	}

	public Function getFunctionDefition()
	{
		return _fun;
	}
}
