...
public class PTABinaryAssignListEachExpr extends BinaryAssignListEachExpr
{
	public PTABinaryAssignListEachExpr(ListHeadExpr listHead, Expr value)
	{
		super(listHead, value);
	}

	public ListHeadExpr getListHead()
	{
		return _listHead;
	}
