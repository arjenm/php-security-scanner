...
/**
 * ObjectMethodExpr with access to the internals.
 *
 * @author Arjen
 */
public class PTAObjectMethodExpr extends ObjectMethodExpr
{
	public PTAObjectMethodExpr(Location location, Expr objExpr, StringValue name, ArrayList<Expr> args)
	{
		super(location, objExpr, name, args);
	}

	public PTAObjectMethodExpr(Expr objExpr, StringValue name, ArrayList<Expr> args)
	{
