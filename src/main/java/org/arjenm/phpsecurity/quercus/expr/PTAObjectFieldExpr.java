...
public class PTAObjectFieldExpr extends ObjectFieldExpr
{
	public PTAObjectFieldExpr(Location location, Expr objExpr, StringValue name)
	{
		super(location, objExpr, name);
	}

	public PTAObjectFieldExpr(Expr objExpr, StringValue name)
	{
		super(objExpr, name);
	}
