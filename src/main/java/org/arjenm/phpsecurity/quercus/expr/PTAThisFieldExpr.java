...
public class PTAThisFieldExpr extends ThisFieldExpr
{
	public PTAThisFieldExpr(Location location, ThisExpr qThis, StringValue name, boolean isInStaticClassScope)
	{
		super(location, qThis, name, isInStaticClassScope);
	}
