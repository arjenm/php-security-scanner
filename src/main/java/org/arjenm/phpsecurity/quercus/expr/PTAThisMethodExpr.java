 ...
 * @author Arjen
 */
public class PTAThisMethodExpr extends ThisMethodExpr
{
	public PTAThisMethodExpr(Location location, ThisExpr qThis, StringValue methodName, ArrayList<Expr> args, boolean isInStaticClassScope)
	{
