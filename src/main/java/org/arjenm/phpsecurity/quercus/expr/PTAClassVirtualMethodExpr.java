...
public class PTAClassVirtualMethodExpr extends ClassVirtualMethodExpr
{
	public PTAClassVirtualMethodExpr(Location location, StringValue methodName, ArrayList<Expr> args)
	{
		super(location, methodName, args);
	}

	public PTAClassVirtualMethodExpr(Location location, StringValue name, Expr[] args)
	{
