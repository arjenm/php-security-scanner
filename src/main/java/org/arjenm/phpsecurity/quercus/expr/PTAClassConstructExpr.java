...
public class PTAClassConstructExpr extends ClassConstructExpr
{
	public PTAClassConstructExpr(Location location, String className, ArrayList<Expr> args)
	{
		super(location, className, args);
	}

	public PTAClassConstructExpr(Location location, String className, Expr[] args)
	{
		super(location, className, args);
	}
