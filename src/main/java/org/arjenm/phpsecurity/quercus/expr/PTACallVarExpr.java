...
public class PTACallVarExpr extends CallVarExpr
{
	public PTACallVarExpr(Location location, Expr name, ArrayList<Expr> args)
	{
		super(location, name, args);
	}

	public PTACallVarExpr(Location location, Expr name, Expr[] args)
	{
		super(location, name, args);
	}

	public PTACallVarExpr(Expr name, ArrayList<Expr> args)
	{
		super(name, args);
	}

	public PTACallVarExpr(Expr name, Expr[] args)
	{
		super(name, args);
	}
