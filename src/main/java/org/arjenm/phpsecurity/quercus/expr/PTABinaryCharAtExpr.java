...
public class PTABinaryCharAtExpr extends BinaryCharAtExpr
{
	public PTABinaryCharAtExpr(Location location, Expr objExpr, Expr indexExpr)
	{
		super(location, objExpr, indexExpr);
	}

	public PTABinaryCharAtExpr(Expr objExpr, Expr indexExpr)
	{
