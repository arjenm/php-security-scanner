...
public class PTAObjectFieldVarExpr extends ObjectFieldVarExpr
{
	public PTAObjectFieldVarExpr(Location location, Expr objExpr, Expr nameExpr)
	{
		super(location, objExpr, nameExpr);
	}

	public PTAObjectFieldVarExpr(Expr objExpr, Expr nameExpr)
	{
