...
public class PTAObjectMethod extends ObjectMethod
{
	public PTAObjectMethod(ExprFactory exprFactory, Location location, InterpretedClassDef quercusClass, String name, FunctionInfo info, Arg[] argList, Statement[] statementList)
	{
		super(exprFactory, location, quercusClass, name, info, argList, statementList);
	}
